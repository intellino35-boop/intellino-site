...
export const realisationBorders = {
...
export const formatPostDate = (date, withDay = true) =>
    new Date(date).toLocaleDateString('fr-FR', withDay ? { day: 'numeric', month: 'long', year: 'numeric' } : { year: 'numeric' });
